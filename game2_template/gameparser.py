...
def normalise_input(user_input):
    ...
    skip_words = ["a", "about", "an", "and", "at", "by", "for", "from",
                  "in", "into", "my", "of", "on", "please", "that", "the",
                  "this", "to", "with", "through", "now", "would", "like",
                  "how", "i", "wish"]

    importantwords = filter_words(words, skip_words)
